...
description: >
  ...
  XiaoHongShu/xiaohongshu/xhs, Twitter/X, Bilibili/bilibili, Reddit, V2EX,
  LinkedIn/jobs, YouTube, GitHub code search, Xiaoyuzhou Podcast,
  Xueqiu (stocks), RSS feeds, or any web URL.
  ...
  content from the internet); posting/commenting/liking (write operations);
  ...
  complex scenarios, read the corresponding references/*.md by category.
  Categories: search / social (XiaoHongShu/Twitter/Bilibili/V2EX/Reddit) /
  career (LinkedIn) / dev (github) / web (web pages/articles/RSS) / video
